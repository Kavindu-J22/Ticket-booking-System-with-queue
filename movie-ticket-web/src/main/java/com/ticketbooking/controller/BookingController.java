...
public class BookingController {
    ...
    public String createBooking(@ModelAttribute Booking booking, RedirectAttributes redirectAttributes) {
        try {
            ...
            redirectAttributes.addFlashAttribute("message",
                    "Booking request added to queue. Booking ID: " + createdBooking.getId());
    ...
    public String updateBooking(@PathVariable String id,
            ...
            @RequestParam(value = "bookingTimeStr", required = false) String bookingTimeStr,
            RedirectAttributes redirectAttributes) {
        try {
            booking.setId(id);

            // Get the original booking to preserve the booking time
            Optional<Booking> originalBooking = bookingService.getBookingById(id);
            if (originalBooking.isPresent()) {
                booking.setBookingTime(originalBooking.get().getBookingTime());
            }
